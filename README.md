...
2. Create a new database instance in [Neon](https://neon.tech/).
...
4. Edit the `SHADOW_DATABASE_URL` variable in `.env`, to configure your [Shadow Database](https://www.prisma.io/docs/concepts/components/prisma-migrate/shadow-database)). Leave `?schema=shadow` at the end.
