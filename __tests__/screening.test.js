...
describe('The Screening Model', () => {
    describe('Requirement 3', () => {
        ...
        it('has fields with the correct structures', () => {
            ...
            // THEN
            expect(actualFieldStructures).toMatchObject(
                expectedFieldStructures
            );
        });
    });
    ...
    describe('Requirement 4', () => {
        it('has all of the necessary fields (columns)', () => {
            // GIVEN
            const expectedFields = generateSortedFields([
                'startsAt',
                'movieId',
                'movie',
            ]);
    ...
    describe('Requirement 6', () => {
        ...
        it('has fields with the correct structures', () => {
            ...
            const expectedFieldStructures = {
                ...
                tickets: generateFieldStructure(
                    'Ticket',
                    false,
                    true,
                    false,
